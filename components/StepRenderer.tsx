              ...
              <div className="space-y-6 mt-6 p-6 bg-slate-50 rounded-xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <Input label="Title or Dept" value={data.designated_contacts.harassment_discrimination_complaints.alternate_recipient.title_or_department} onChange={(v) => onChange('designated_contacts.harassment_discrimination_complaints.alternate_recipient.title_or_department', v)} required error={errors.har_a_title} />
                    {data.designated_contacts.harassment_discrimination_complaints.alternate_recipient.display_style === 'NameAndTitle' && <Input label="Person Name" value={data.designated_contacts.harassment_discrimination_complaints.alternate_recipient.person_name} onChange={(v) => onChange('designated_contacts.harassment_discrimination_complaints.alternate_recipient.person_name', v)} required error={errors.har_a_name} />}
                    <Input label="Email" value={data.designated_contacts.harassment_discrimination_complaints.alternate_recipient.email} onChange={(v) => onChange('designated_contacts.harassment_discrimination_complaints.alternate_recipient.email', v)} />
                  </div>
                </div>
